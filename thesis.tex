...
\begin{deluxetable}{llrrrll}
	...
	\tablehead{\colhead{Name} &  \colhead{Observation Time} &   \colhead{RA} &  \colhead{DEC} &    \colhead{Time On Target} &  \colhead{Bandpass} & \colhead{Complex Gain} \\ 
	\colhead{} &  \colhead{(UT)} &   \colhead{(deg)} &  \colhead{(deg)} &    \colhead{(hrs)} &  \colhead{} & \colhead{} \\}
	\startdata
...
\includepdf[pages={1-},scale=0.75]{elsevierpubagree.pdf}
