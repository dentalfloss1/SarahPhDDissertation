...
% We will discuss an alternative method for determining the detection threshold in~\ref{sec:fdthresh}.
\begin{figure}
	% \includegraphics[width=0.9\textwidth]{ro_figure_1.png}
...
\begin{deluxetable}{lllllllll}
	...
	\tablehead{		\colhead{Source} &       \colhead{RA }&     \colhead{ DEC} &  \colhead{Sep.} &   \colhead{$F_{int}$}  &    \colhead{$F_{pk}$}&  \colhead{ Freq.} &               \colhead{ Date} &       \colhead{Source} \\
	\colhead{}	&    \colhead{  }  &   \colhead{ }   &\colhead{  (arcsec)} &  \colhead{ (mJy)}  &    \colhead{(mJy)} & \colhead{  (GHz)} &  \colhead{ } &        \colhead{}        \\      }
	\startdata
1252675 & 157.3791 &  29.8533 &       1 & $2.3\pm0.53$     &$1.4 \pm 0.21 $& 2.7 & 2019-04-22 23:38:59 &        VLASS \\
